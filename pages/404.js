...
export default function FourOhFour() {
    return (
        <>
            <section className="bg-[#212D94] relative z-10 py-[120px]">
                    ...
                    <div className="-mx-4 flex">
                        <div className="w-full px-4">
                            <div className="mx-auto max-w-[400px] text-center">
                                ...
                                <a
                                    href="/"
                                    className="hover:text-[#212D94] inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white"
                                >
                                    Go To Home
                                </a>
                            </div>
