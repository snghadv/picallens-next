...
export default function Contact() {
    return (
        <>
            <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] px-5 lg:px-0">
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p className="text-body-color mb-9 text-base leading-relaxed">
                                    Picallens is designed for learing and development of students and working professionals. Connect Us for support with our platform.
                                </p>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div
                                        className="bg-[#212D94] text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                                    >
                                        <svg
                                            width="24"
                                            height="24"
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">Coming Soon</p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">support@picallens.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                                <form>
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            className="bg-[#212D94] border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                                        >
                                            Send Message
                                        </button>
                                    </div>
