...
export default function Navbar() {
    return (
        <Disclosure as="nav" className="bg-[#212D94] sticky top-0 left-0 z-50">
            {({ open }) => (
                <>
                        ...
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex flex-shrink-0 items-center">
                                    <Link href={"/tutorials"}>
                                        <img className="block h-8 w-auto lg:hidden" src="https://storage.cloud.google.com/picallens/Logo.svg?authuser=2" alt="Picallens Logo" />
                                        <img className="hidden h-8 w-auto lg:block" src="https://storage.cloud.google.com/picallens/Logo.svg?authuser=2" alt="Picallens Logo" />
                                    </Link>
                                </div>
